...
{
    public const string Completo = @";GUTTYTECH-RL-OPTIMIZER=COMPLETO;v22.3.34
[SystemSettings]
UseDirectSound=True
StaticDecals=False
DynamicDecals=True
...
";
    ...
    public const string Criador = @";GUTTYTECH-RL-OPTIMIZER=CRIADOR;v22.3.34
[SystemSettings]
UseDirectSound=True
StaticDecals=False
DynamicDecals=True
...
";
    ...
    public const string Stock = @"[SystemSettings]
UseDirectSound=True
StaticDecals=True
DynamicDecals=True
UnbatchedDecals=True
...
[SystemSettingsTexturesDerp]
BasedOn=SystemSettings
TEXTUREGROUP_Character=(MinLODSize=1,MaxLODSize=128,LODBias=0)
TEXTUREGROUP_CharacterNormalMap=(MinLODSize=1,MaxLODSize=128,LODBias=0)
TEXTUREGROUP_CharacterSpecular=(MinLODSize=1,MaxLODSize=128,LODBias=0)
...
TEXTUREGROUP_Weapon=(MinLODSize=1,MaxLODSize=128,LODBias=0)
...
TEXTUREGROUP_World=(MinLODSize=1,MaxLODSize=128,LODBias=0)
