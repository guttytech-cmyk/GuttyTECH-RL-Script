...
internal static partial class Ui
{
    ...
    public static void Banner(bool animate)
    {
        ...
        Console.WriteLine();
        Console.WriteLine(new string(' ', spad) + C(sub, Gray) + "   " + Bg(Red) + Fg(White) + " v22.3.2 " + Reset + " " + C("TESSERACT", RedHi));
        Console.WriteLine();
    }
    ...
    private static void BannerCompact()
    {
        ...
        Console.WriteLine(m + C("RL INI OPTIMIZER", Gray) + "  " + Bg(Red) + Fg(White) + " v22.3.2 " + Reset + " " + C("TESSERACT", RedHi));
        Console.WriteLine();
    }
